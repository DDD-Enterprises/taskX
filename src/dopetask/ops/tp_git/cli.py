"""CLI surface for dopetask tp git workflows."""
...
from dopetask.ops.tp_git.git_worktree import cleanup_tp, list_worktrees, start_tp, sync_main
...
def list_cmd(
    ...
    """List worktrees and highlight dopeTask TP worktree paths."""
    try:
