...
def create_dopetask_repo(repo_root: Path, project_id: str = "dopetask.core") -> Path:
    """Initialize a minimal dopeTask repo directory with identity rails."""
    repo_root.mkdir(parents=True, exist_ok=True)
    (repo_root / ".dopetaskroot").write_text("", encoding="utf-8")
    project_identity = repo_root / ".dopetask" / "project.json"
...
def write_availability(
    ...
    *,
    ...
    runtime_path = repo_root / ".dopetask" / "runtime"
